...
MACRO_CONFIG_STR(ClAssetPortals, cl_asset_portals, 50, "default", CFGFLAG_SAVE | CFGFLAG_CLIENT, "The asset for the game graphics that do not come from Teeworlds")
